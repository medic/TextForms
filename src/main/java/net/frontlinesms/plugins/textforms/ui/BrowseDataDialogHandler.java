...
public class BrowseDataDialogHandler implements ThinletUiEventHandler {
	...
	private static final TextFormsLogger LOG = TextFormsLogger.getLogger(BrowseDataDialogHandler.class);
	private static final String DIALOG_XML = "/ui/plugins/textforms/browseDataDialog.xml";
	...
	public BrowseDataDialogHandler(UiGeneratorController ui, ApplicationContext appContext, TextFormsCallback callback) { 
	...
	public void saveAnswer(Object dialog) throws DuplicateKeyException {
		...
		if (contact == null) {
			this.ui.alert(getI18NString(TextFormsConstants.ALERT_MISSING_RESPONSE_SUBMITTER));
		}
		else if (question == null) {
			this.ui.alert(getI18NString(TextFormsConstants.ALERT_MISSING_RESPONSE_FIELD));
		}
		else if (dateSubmitted == null) {
			this.ui.alert(getI18NString(TextFormsConstants.ALERT_MISSING_RESPONSE_DATE));
		}
		else if (response == null || response.length() == 0) {
			this.ui.alert(getI18NString(TextFormsConstants.ALERT_MISSING_RESPONSE_TEXT));
		}
			...
			if (newAnswer != null) {
				...
				this.ui.alert(getI18NString(TextFormsConstants.ALERT_ERROR_CREATE_RESPONSE));
			}
