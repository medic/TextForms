...
import net.frontlinesms.plugins.textforms.search.QuestionQueryGenerator;
...
public class ManageQuestionsPanelHandler implements ThinletUiEventHandler, AdvancedTableActionDelegate, EventObserver {
	...
	private static final TextFormsLogger LOG = TextFormsLogger.getLogger(ManageQuestionsPanelHandler.class);
	private static final String PANEL_XML = "/ui/plugins/textforms/manageQuestionsPanel.xml";
	...
	public ManageQuestionsPanelHandler(UiGeneratorController ui, ApplicationContext appContext, TextFormsCallback callback, FrontlineSMS frontlineController) {
		...
		this.tableController.putHeader(Question.class, 
									   new String[]{getI18NString(TextFormsConstants.TABLE_QUESTIONNAME), 
													getI18NString(TextFormsConstants.TABLE_KEYWORD), 
													getI18NString(TextFormsConstants.TABLE_TYPE),
													getI18NString(TextFormsConstants.TABLE_SCHEMA)}, 
	...
	public void showConfirmationDialog(String methodToBeCalled) {
		this.ui.showConfirmationDialog(methodToBeCalled, this, TextFormsConstants.CONFIRM_DELETE_QUESTION);
	}
	...
	public void selectionChanged(Object selectedObject) {
		...
		if (question != null) {
			...
			if ("boolean".equalsIgnoreCase(question.getType())) {
				String choicesLabel = String.format("%s, %s", TextFormsMessages.getMessageTrue(), TextFormsMessages.getMessageFalse());
	...
	public void focusLost(Object textfield) {
		...
		if (searchText == null || searchText.length() == 0) {
			this.ui.setText(textfield, TextFormsMessages.getMessageSearchQuestions());
