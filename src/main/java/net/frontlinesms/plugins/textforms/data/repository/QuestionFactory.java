...
public final class QuestionFactory {
	...
	private static final TextFormsLogger LOG = TextFormsLogger.getLogger(QuestionFactory.class);
	
	/**
	 * Get list of Question classes
	 * (To add a new Question classes to the project, append a new row to the file
	 * /resources/META-INF/services/net.frontlinesms.plugins.textforms.data.domain.questions.Question
