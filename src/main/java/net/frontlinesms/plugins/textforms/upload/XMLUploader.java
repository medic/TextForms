...
public class XMLUploader extends DocumentUploader {
	...
	private static final TextFormsLogger LOG = TextFormsLogger.getLogger(XMLUploader.class);
	...
	public String getTitle() {
		return InternationalisationUtils.getI18NString(TextFormsConstants.DOCUMENT_UPLOAD_XML);
	}
	
	@Override
	protected String getPanelXML() {
		return "/ui/plugins/textforms/upload/XMLUploader.xml";
	}
