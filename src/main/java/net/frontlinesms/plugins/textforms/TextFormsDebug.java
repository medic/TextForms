...
public class TextFormsDebug {
	
	private static final TextFormsLogger LOG = TextFormsLogger.getLogger(TextFormsDebug.class);
	 ...
	 */
	public TextFormsDebug(ApplicationContext appContext) {
