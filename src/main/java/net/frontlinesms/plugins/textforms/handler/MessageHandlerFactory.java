...
public final class MessageHandlerFactory {
	...
	private static final TextFormsLogger LOG = TextFormsLogger.getLogger(MessageHandlerFactory.class);
	
	/**
	 * Get list of MessageHandlers
	 * (To add a new MessageHandler to the project, append a new row to the file
	 * /resources/META-INF/services/net.frontlinesms.plugins.textforms.handler.MessageHandler
