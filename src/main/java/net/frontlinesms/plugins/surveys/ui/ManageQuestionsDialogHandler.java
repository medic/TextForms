...
public class ManageQuestionsDialogHandler implements ThinletUiEventHandler {
	...
	public ManageQuestionsDialogHandler(UiGeneratorController ui, ApplicationContext appContext, SurveysCallback callback) { 
	...
	public void saveQuestion(Object dialog) throws DuplicateKeyException {
		...
		try {
			if (name == null || name.length() == 0) {
				this.ui.alert(SurveysMessages.getMessageMissingQuestion());
			}
			else if (keyword == null || keyword.length() == 0) {
				this.ui.alert(SurveysMessages.getMessageMissingKeyword());
			}
			else if (type == null || type.length() == 0) {
				this.ui.alert(SurveysMessages.getMessageMissingType());
			}
			else if (hasDuplicateChoices(choices)) {
				this.ui.alert(SurveysMessages.getMessageDuplicateChoice());
			}
			...
			this.ui.alert(SurveysMessages.getMessageDuplicateKeyword());
		}
	}
	...
	public void questionTypeChanged(Object comboTypes, Object panelChoices, Object listChoices) {
		...
		if ("boolean".equalsIgnoreCase(selectedType)) {
			this.ui.add(listChoices, this.ui.createListItem(SurveysMessages.getMessageTrue(), 1));
			this.ui.add(listChoices, this.ui.createListItem(SurveysMessages.getMessageFalse(), 0));
