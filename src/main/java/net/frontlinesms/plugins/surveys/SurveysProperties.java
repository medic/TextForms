...
public class SurveysProperties extends UserHomeFilePropertySet {
	...
	private static SurveysProperties instance;
	
	protected SurveysProperties() {
		super("surveys");
	}

	private static synchronized SurveysProperties getInstance() {
		if (instance == null) {
			instance = new SurveysProperties();
		}
		return instance;
	}
