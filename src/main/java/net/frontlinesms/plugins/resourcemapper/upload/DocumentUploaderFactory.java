...
public final class DocumentUploaderFactory {
	...
	private static ResourceMapperLogger LOG = ResourceMapperLogger.getLogger(DocumentUploaderFactory.class);
	
	/**
	 * Get list of DocumentUploader handlers
	 * (To add a new DocumentUploader to the project, append a new row to the file
	 * /resources/META-INF/services/net.frontlinesms.plugins.resourcemapper.upload.DocumentUploader
	...
	public static DocumentUploader createDocumentUploader() {
		DocumentUploader documentUploader = ResourceMapperProperties.getDocumentUploader();
