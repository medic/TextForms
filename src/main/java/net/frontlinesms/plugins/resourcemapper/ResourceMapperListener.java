 ...
 *
 */
public class ResourceMapperListener implements EventObserver {

	private static ResourceMapperLogger LOG = ResourceMapperLogger.getLogger(ResourceMapperListener.class);
	 ...
	 */
	public ResourceMapperListener(FrontlineSMS frontlineController, ApplicationContext appContext) {
	 ...
	 */
	public ResourceMapperListener(FrontlineSMS frontlineController, ApplicationContext appContext, boolean listening) {
